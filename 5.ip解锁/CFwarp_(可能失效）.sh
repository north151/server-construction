...
[[ "$result4" == "404" ]] && NF="当前IP仅解锁奈飞Netflix自制剧"
[[ "$result4" == "403" ]] && NF="当前IP不支持解锁奈飞Netflix"
[[ "$result4" == "000" ]] && NF="网络有问题，尝试再次进入脚本"
[[ "$result4" == "200" ]] && NF="当前IP可解锁奈飞Netflix流媒体"
...
[[ "$result6" == "404" ]] && NF="当前IP仅解锁奈飞Netflix自制剧"
[[ "$result6" == "403" ]] && NF="当前IP不支持解锁奈飞Netflix"
[[ "$result6" == "000" ]] && NF="网络有问题，可尝试再次进入脚本"
[[ "$result6" == "200" ]] && NF="当前IP可解锁奈飞Netflix流媒体"
...
[[ "$result" == "404" ]] && NF="当前IP仅解锁奈飞Netflix自制剧..."
[[ "$result" == "403" ]] && NF="当前IP不支持解锁奈飞Netflix"
[[ "$result" == "000" ]] && NF="网络有问题，可尝试再次进入脚本"
[[ "$result" == "200" ]] && NF="当前IP可解锁奈飞Netflix流媒体"
